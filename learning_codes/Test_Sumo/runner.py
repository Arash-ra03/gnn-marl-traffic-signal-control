...
def check():
    ...
    print("✔️ END CHECK")
print("🟥 before adding a new logic")
check()
...
phases.append(sumolib.net.Phase(20, "rrrrGGggrrrrGGgg", 0, 0)) # what is this??
logic.phases = phases # IMPORTANT
...
print("🟥 after adding a new logic")
check()
...
print("subscription results",traci.trafficlight.getSubscriptionResults(tlsID))
